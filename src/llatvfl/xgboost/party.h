...
struct SecureBoostParty : XGBoostParty
{
    ...
    void receive_publikey(PaillierPublicKey pk_)
    {
        pk = pk_;
    }

    vector<vector<pair<PaillierCipherText, PaillierCipherText>>> greedy_search_split(vector<PaillierCipherText> &gradient,
