...
TEST(DOK, DOKHalfTest)
{
    SparseMatrixDOK<half> sm = SparseMatrixDOK<half>(3, 3, (half)0, false, true);
    sm.add(1, 1, (half)0.5);
    sm.add(2, 1, (half)0.1);
    sm.add(1, 1, (half)-0.5);
    sm.add(2, 1, (half)0.3);
    ...
    vector<vector<half>> test_adj_mat = {{(half)0, (half)0, (half)1.0},
                                         {(half)0, (half)0, (half)0},
                                         {(half)0, (half)0.4, (half)0}};
    vector<vector<half>> adj_mat = sm.to_densematrix((half)0);
    ...
    sm = SparseMatrixDOK<half>(3, 3, (half)0, false, true);
    sm.from_densematrix(test_adj_mat);
    vector<vector<half>> reconstructed_dm = sm.to_densematrix((half)0);
    for (int i = 0; i < test_adj_mat.size(); i++)
    {
        for (int j = 0; j < test_adj_mat[i].size(); j++)
        {
    ...
    SparseMatrixDOK<half> sm_symme = SparseMatrixDOK<half>(3, 3, (half)0, true, true);
    sm_symme.add(1, 1, (half)0.5);
    sm_symme.add(2, 1, (half)0.1);
    sm_symme.add(1, 1, (half)-0.5);
    sm_symme.add(2, 1, (half)0.3);
    sm_symme.add(0, 2, (half)1);

    vector<vector<half>> test_adj_mat_symme = {{(half)0, (half)0, (half)1.0},
                                               {(half)0, (half)0, (half)0.4},
                                               {(half)1.0, (half)0.4, (half)0}};
    vector<vector<half>> adj_mat_symme = sm_symme.to_densematrix((half)0);
    ...
    sm_symme = SparseMatrixDOK<half>(3, 3, (half)0, true, true);
    sm_symme.from_densematrix(test_adj_mat_symme);
    vector<vector<half>> reconstructed_dm_symme = sm_symme.to_densematrix((half)0);
    for (int i = 0; i < test_adj_mat_symme.size(); i++)
    {
        for (int j = 0; j < test_adj_mat_symme[i].size(); j++)
        {
